...
-- 定義 OnsiteCourse 和 Course 之間的關聯性。
...
-- 定義 OnlineCourse 和 Course 之間的關聯性。
IF NOT EXISTS (SELECT * FROM sys.foreign_keys
...
-- 定義 StudentGrade 和 Course 之間的關聯性。
IF NOT EXISTS (SELECT * FROM sys.foreign_keys
...
-- 定義 StudentGrade 和 Student 之間的關聯性。
IF NOT EXISTS (SELECT * FROM sys.foreign_keys
...
-- 定義 CourseInstructor 和 Course 之間的關聯性。
IF NOT EXISTS (SELECT * FROM sys.foreign_keys
...
-- 定義 CourseInstructor 和 Person 之間的關聯性。
IF NOT EXISTS (SELECT * FROM sys.foreign_keys
...
-- 定義 OfficeAssignment 和 Person 之間的關聯性。
IF NOT EXISTS (SELECT * FROM sys.foreign_keys
...
-- 建立 InsertOfficeAssignment 預存程序。
IF NOT EXISTS (SELECT * FROM sys.objects
...
-- 建立 UpdateOfficeAssignment 預存程序。
IF NOT EXISTS (SELECT * FROM sys.objects
...
-- 建立 DeleteOfficeAssignment 預存程序。
IF NOT EXISTS (SELECT * FROM sys.objects
